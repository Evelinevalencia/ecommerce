        ...
        <div class="navbar-nav navFlex">
          <div class="navKiri">
            <ul class="ulKiri">
              ...
              <li class="nav-item">
                <a class="nav-link navTulisanadmin" href="{{URL::to('/product')}}">Produk</a>
              </li>
              <li class="nav-item">
                <a class="nav-link navTulisan" href="{{url('/designadmin')}}">Desain</a>
              </li>
              <li class="nav-item">
                <a class="nav-link navTulisanadmin" href="{{url('/tabeltransaksi')}}">Transaksi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link navTulisanadmin" href="{{url('/pengeluaran')}}">Pengeluaran</a>
              </li>
            </ul>
          </div>
          <div class="navKanan">
              ...
              <!-- <li class="nav-item">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item dropdownL-K" href="#">Action</a></li>
                    <li><a class="dropdown-item dropdownL-K" href="#">Another action</a></li>
